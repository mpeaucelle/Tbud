---
title: Supplementary information to "Plants phenological sensitivity to warming lies in their energy budget"
...
This R-Markdown document provides the instructions for executing the analysis and producing figures presented in the paper *Plants phenological sensitivity to warming lies in their energy budget* by Peaucelle, Penuelas and Verbeeck (2020, submitted). 
...
$$
\mathrm{LW}_{\mathrm{bud}} = \mathrm{\sigma}\mathrm{\varepsilon}\mathrm{T}_{\mathrm{bud}}^4
$$
where $\mathrm{\sigma}$ is the Stefan-Boltzmann constant and ${\mathrm{\varepsilon}}$ is the bud emissivity (which is equal to its absorptivity) to longwave radiations.
